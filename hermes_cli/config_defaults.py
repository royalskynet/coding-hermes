...
DEFAULT_CONFIG = {
    ...
    "gateway": {
        "health_gate": {
            ...
            "telegram_backoff_initial_seconds": 1,
            "telegram_backoff_multiplier": 2,
            "telegram_backoff_maximum_seconds": 60,
            "telegram_breaker_failure_threshold": 5,
            "telegram_breaker_cooldown_seconds": 60,
            "critical_fd": 240,

...
#   - platform: gateway_only operator command (pause/resume/list a failing
#     gateway platform). Never registrable as a Slack native slash; upstream
#     routes it through /hermes platform for the same reason.
